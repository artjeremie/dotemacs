...
(custom-theme-set-faces
 ...
 '(org-agenda-structure ((t (:foreground "#bb9af7" :inherit variable-pitch))))
 '(org-agenda-date ((t (:foreground "#2ac3de" :inherit variable-pitch))))
 '(org-agenda-date-weekend ((t (:foreground "#2ac3de" :inherit variable-pitch))))
 '(org-agenda-date-weekend-today ((t (:foreground "#2ac3de" :bold t :inherit variable-pitch))))
 '(org-agenda-date-today ((t (:foreground "#2ac3de" :bold t :inherit variable-pitch))))
